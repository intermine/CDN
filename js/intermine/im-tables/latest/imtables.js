...
(function() {
  ...
  scope("intermine.query", function(exporting) {
    ...
    return exporting(ConstraintAdder = (function(_super) {
      ...
      ConstraintAdder.name = 'ConstraintAdder';
      ...
      ResultsTable.prototype.addColumnHeaders = function(result) {
        ...
        _fn = function(view, i) {
          ...
          sortButton.click(function(e) {
            ...
            return console.log(q.sortOrder);
          });
  ...
  scope("intermine.query.results", function(exporting) {
    ...
    exporting(DropDownColumnSummary = (function(_super) {
      ...
      DropDownColumnSummary.name = 'DropDownColumnSummary';
    ...
    return SummaryHeading = (function(_super) {
      ...
      SummaryHeading.name = 'SummaryHeading';
      ...
      SummaryHeading.prototype.initialize = function(query, view) {
        ...
        this.query = query;
        this.view = view;
        return this.query.on("got:summary:total", function(path, total) {
          if (path === _this.view) {
            return _this.$('.im-item-count').text(intermine.utils.numToString(total, ",", 3));
          }
        });
      };
  ...
  scope("intermine.query.filters", function(exporting) {
    ...
    SingleConstraintAdder = (function(_super) {
      ...
      SingleConstraintAdder.name = 'SingleConstraintAdder';
    ...
    return exporting(SingleColumnConstraints = (function(_super) {
      ...
      SingleColumnConstraints.name = 'SingleColumnConstraints';
  ...
  scope("intermine.query.columns", function(exporting) {
    ...
    CurrentColumns = (function(_super) {
      ...
      CurrentColumns.name = 'CurrentColumns';
  ...
  scope("intermine.query.actions", function(exporting) {
    ...
    ListDialogue = (function(_super) {
      ...
      ListDialogue.name = 'ListDialogue';
  ...
  scope("intermine.query.results.table", function(exporting) {
    ...
    return exporting(ColumnOrderer = (function(_super) {
      ...
      ColumnOrderer.name = 'ColumnOrderer';
  ...
  scope("intermine.results", function(exporting) {
    ...
    exporting(ColumnSummary = (function(_super) {
      ...
      ColumnSummary.name = 'ColumnSummary';
    ...
    exporting(FrequencyFacet = (function(_super) {
      ...
      FrequencyFacet.name = 'FrequencyFacet';
      ...
      FrequencyFacet.prototype.render = function() {
        ...
        promise = this.query.summarise(this.facet.path, this.limit, function(items, total) {
          var hf, more, pf;
          _this.query.trigger("got:summary:total", _this.facet.path, total);
          $progress.remove();
          _this.$dt.append(" (" + total + ")");
          if (total > _this.limit) {
          ...
          if (total <= 12 && !_this.query.canHaveMultipleValues(_this.facet.path)) {
            pf = new PieFacet(_this.query, _this.facet, items);
            _this.$el.append(pf.el);
            pf.render();
          } else {
            hf = new HistoFacet(_this.query, _this.facet, items);
    ...
    exporting(PieFacet = (function(_super) {
      ...
      PieFacet.prototype.initialize = function(query, facet, items) {
        var _ref,
          _this = this;
        this.query = query;
        this.facet = facet;
      ...
      PieFacet.prototype.addConstraint = function(e) {
        var item, newCon;
        console.log(this.query, this.facet);
        newCon = {
      ...
      PieFacet.prototype.addChart = function() {
        var chart, cx, cy, degs, h, r, t, texts, total, w, _i, _len,
          _this = this;
        ...
        texts = this.items.map(function(item) {
          ...
          t = _this.paper.text(cx, cy, item.get("item"));
          t.attr({
            "font-size": "14px",
    ...
    return exporting(BooleanFacet = (function(_super) {
      ...
      BooleanFacet.name = 'BooleanFacet';
      ...
      BooleanFacet.prototype.drawControls = function(total, trues) {
        ...
        console.log("Added cancel event to: ", c.find('.btn-cancel').click(function(e) {
        ...
        console.log("Added cancel event to: ", c.find('.btn-primary').click(function(e) {
  ...
  scope("intermine.query", function(exporting) {
    ...
    exporting(ActiveConstraint = (function(_super) {
      ...
      ActiveConstraint.name = 'ActiveConstraint';
    ...
    return exporting(NewConstraint = (function(_super) {
      ...
      NewConstraint.name = 'NewConstraint';
