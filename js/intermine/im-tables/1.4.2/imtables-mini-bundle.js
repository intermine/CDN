...
/*
 * InterMine Results Tables Library v1.4.2
...
(function() {
  ...
  (function() {
    var BIO_FORMATS, DELENDA, ENTER, EXPORT_FORMATS, ExportDialogue, SPACE, Tab, anyAny, anyNodeIsSuitable, featuresToPaths, formatByExtension, idAttr, isImplicitlyConstrained, isIncluded, isntExcluded, toPath, _ref;
    ...
    ResultsTable = (function(_super) {
      ...
      ResultsTable.prototype.getEffectiveView = function(row) {
        ...
        return this.query.service.get("/classkeys").then(function(_arg) {
          var cell, classKeys, classes, col, cols, commonPrefix, explicitReplacements, fName, formatter, getReplacedTest, isReplaced, longestCommonPrefix, p, pType, path, q, r, replacedBy, replaces, subPath, v, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _name, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _results;
          ...
          for (_i = 0, _len = cols.length; _i < _len; _i++) {
            ...
            if ((formatter != null ? formatter.showParentInHeader : void 0) || (formatter && (classKeys != null ? (_ref2 = classKeys[pType]) != null ? _ref2[fName] : void 0 : void 0))) {
              if ((_ref3 = replacedBy[_name = p.getParent()]) == null) {
          ...
          for (_m = 0, _len4 = cols.length; _m < _len4; _m++) {
            ...
            if (col.isFormatted) {
              if (_ref8 = col.path, __indexOf.call(col.replaces, _ref8) < 0) {
