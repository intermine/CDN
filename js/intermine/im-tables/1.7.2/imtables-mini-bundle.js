...
/*
 * InterMine Results Tables Library v1.7.2
 ...
 * 
 * Built at Mon Aug 04 2014 13:57:34 GMT+0100 (BST)
*/
...
(function() {
  ...
  (function() {
    var CellCutoff, HIDDEN_FIELDS, ItemDetails, NUM_CHUNK_SIZE, NUM_SEPARATOR, Preview, ReferenceCounts, getLeaves, numToStr, sortByName, sortTableByFieldName, toField, _ref, _ref1, _ref2, _ref3;
    ...
    ItemDetails = (function(_super) {
      ...
      function ItemDetails() {
        _ref1 = ItemDetails.__super__.constructor.apply(this, arguments);
        return _ref1;
      }
    ...
    ReferenceCounts = (function(_super) {
      ...
      function ReferenceCounts() {
        _ref2 = ReferenceCounts.__super__.constructor.apply(this, arguments);
        return _ref2;
      }
    ...
    Preview = (function(_super) {
      ...
      function Preview() {
        this.handleItem = __bind(this.handleItem, this);        _ref3 = Preview.__super__.constructor.apply(this, arguments);
        return _ref3;
      }
      ...
      Preview.prototype.formatName = function(field) {
        var e, p, t, _i, _len, _ref4;

        p = null;
        _ref4 = this.model.get('type').split(',');
        for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
          t = _ref4[_i];
          if (p == null) {
            p = (function() {
      ...
      Preview.prototype.fetchData = function() {
        var fetches, id, schema, service, t, type, types, _ref4, _ref5;

        _ref4 = this.model.toJSON(), type = _ref4.type, id = _ref4.id;
        _ref5 = this.options, schema = _ref5.schema, service = _ref5.service;
        types = type.split(',');
        fetches = (function() {
          var _i, _len, _ref6, _results;
      ...
      Preview.prototype.getRelationCounts = function() {
        ...
        countSets = (function() {
          ...
          for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
            type = _ref4[_i];
            _results.push((function() {
              var _j, _len1, _ref5, _ref6, _ref7, _results1;

              _ref7 = (_ref5 = (_ref6 = intermine.options.preview.count[root]) != null ? _ref6[type] : void 0) != null ? _ref5 : [];
              _results1 = [];
      ...
      Preview.prototype.getRelationCount = function(settings) {
        var counter, id, label, query, table, type, _ref4,
          _this = this;
        ...
        return this.options.service.count(counter).then(function(c) {
      ...
      Preview.prototype.template = function(data) {
        var frag, h4, itemDetailsTable, relationCountTable, _ref4;
  ...
  (function() {
    ...
    ResultsTable = (function(_super) {
      ...
      ResultsTable.prototype.appendRows = function(res) {
        var cell, docfrag, previousCells, row, _i, _j, _len, _len1, _ref1;
