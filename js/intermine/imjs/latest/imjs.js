...
(function(exports, IS_NODE) {
    ...
    ACCEPT_HEADER = {
        ...
        "jsondatatable": "application/json;type=datatable",
        ...
        "jsonpdatatable": "application/json;type=datatable",
...
// Generated by CoffeeScript 1.3.3
(function() {
  var IS_NODE, Query, conAttrs, conStr, conValStr, concatMap, decapitate, f, fold, getListResponseHandler, get_canonical_op, id, idConStr, mth, multiConStr, noValueConStr, partition, root, simpleConStr, take, toQueryString, typeConStr, _, _CLONE, _fn, _get_data_fetcher, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3,
  ...
  if (typeof exports === 'undefined') {
    IS_NODE = false;
    _ = root._;
    _ref = root.intermine.funcutils, partition = _ref.partition, fold = _ref.fold, take = _ref.take, concatMap = _ref.concatMap, id = _ref.id;
    _CLONE = function(o) {
