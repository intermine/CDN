...
// Generated by CoffeeScript 1.3.3
(function() {
  var IS_NODE, Query, conStr, conValStr, concatMap, decapitate, f, fold, getListResponseHandler, get_canonical_op, id, idConStr, mth, multiConStr, partition, root, simpleConStr, take, toQueryString, _, _CLONE, _fn, _get_data_fetcher, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3,
  ...
  idConStr = function(c) {
    return "<constraint path=\"" + c.path + "\" op=\"" + (_.escape(c.op)) + "\" code=\"" + c.code + "\" ids=\"" + (c.ids.join(',')) + "\"/>";
  };
